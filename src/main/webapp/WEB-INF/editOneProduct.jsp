                                ...
                                <div class="container">
                                    <form:form action="/category/create" method="post" modelAttribute="categoryForm">
                                        ...
                                        <div class="input-field">
                                            ...
                                            <form:input path="categoryName" class="validate"  />
                                        </div>
